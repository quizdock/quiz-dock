...
| `revision` | int | NN, DEF 0 | Content revision, +1 at every export today. *(Target with #39: it becomes the publication counter — bumped when the quiz is shared, not by an export.)* |
