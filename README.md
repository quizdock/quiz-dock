...
- 🧩 **A real quiz builder** — seven question types (single/multi choice, true-false,
  text, numeric, reorder, poll), image & audio media, Markdown everywhere, content slides
...
More — my quizzes, content slides, the console during a question and at the reveal,
